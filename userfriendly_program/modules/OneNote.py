...
# Generate Notebook
def CreateNoteBook(year, headers):
...
# Generate Section
def CreateSection(month, notebook_id, headers):
...
# Generate Page
def CreatePage(day, events, section_id, headers, access_token):
